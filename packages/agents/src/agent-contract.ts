...
export const agents: readonly AgentDefinition[] = [
  ...
  { id: "inventory", name: "Inventory Agent", purpose: "Detect stock risk and prepare replenishment actions.", tools: [
    { name: "inventory_adjustment", permission: "inventory:write", description: "Prepare inventory adjustments." },
    { name: "inventory_reorder", permission: "inventory:write", description: "Read tenant inventory and prepare a reorder proposal when stock is at or below the reorder point." },
  ] },
